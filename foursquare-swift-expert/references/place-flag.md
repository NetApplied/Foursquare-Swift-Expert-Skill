...
- Method: `POST`
- Path: `/places/{fsq_place_id}/suggest/flag`
- Operation ID: `place-flag`
...
| fields | string | Yes | List of fields being flagged as incorrect. Possible values are:<ul><li>address</li><li>latitude</li><li>longitude</li><li>locality</li><li>name</li><li>tel</li><li>postcode</li><li>region</li><li>state</li><li>website</li><li>placeActions</li></ul> |  |
| comment | string | No | A comment describing the issue being flagged. |  |
...
struct PlaceFlagRequest: Codable, Identifiable, Hashable {
...
struct PlaceFlagResponse: Codable, Identifiable, Hashable {
    ...
    var id: String { "place-flag-response" }
...
final class PlaceFlagClient {
    ...
    func placeFlag(parameters: PlaceFlagRequest) async throws -> PlaceFlagResponse {
        let endpointPath = "/places/\(parameters.fsqPlaceId)/suggest/flag"
